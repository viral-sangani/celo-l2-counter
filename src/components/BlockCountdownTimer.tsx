      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-3 gap-4 max-w-md mx-auto mb-8">
            <div className="bg-[#476520] rounded-lg p-4 text-white text-center">
          ...
          <div className="text-center">
            <p className="font-medium text-gray-700">
              Blocks remaining: <span className="text-[#476520]">{currentBlock ? Math.max(0, CONSTANTS.TARGET_BLOCK - currentBlock).toLocaleString() : '0'}</span>
            </p>
          </div>
        </>
      )}
